...
def _speech(slug):
    ...
    context['money_quote_image'] = '%s/quote-images/%s.jpg' % (app_config.S3_BASE_URL, slug)
    context['money_quote2_image'] = '%s/quote-images/%s-2.jpg' % (app_config.S3_BASE_URL, slug)
